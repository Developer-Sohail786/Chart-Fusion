...
export default function LineChartPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-800 text-white p-6">
      ...
      <h1 className="text-3xl font-bold mb-2">Line Chart — Users vs Sales</h1>
      <p className="text-sm text-slate-400 mb-6">Comparing users and sales over time.</p>
      ...
      <div className="bg-slate-800 rounded-xl p-4 shadow-lg h-[26.25rem]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
            ...
            <Line  dataKey="users" stroke="#38bdf8" strokeWidth={3} name="Users" />
            <Line dataKey="sales" stroke="#a855f7" strokeWidth={3} name="Sales" />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
